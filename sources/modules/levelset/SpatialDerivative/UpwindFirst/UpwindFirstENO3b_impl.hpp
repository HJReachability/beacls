#ifndef __UpwindFirstENO3b_impl_hpp__
#define __UpwindFirstENO3b_impl_hpp__
...
public:
	...
	UpwindFirstENO3b_Cache() : cachedBoundedSrcs(2), boundedSrc_ptrs(2) {}
};
...
private:
	...
	UpwindFirstENO3b_Cache *cache;
	std::vector<beacls::CudaStream*> cudaStreams;
public:
	UpwindFirstENO3b_impl(
	...
	bool operator==(const UpwindFirstENO3b_impl& rhs) const;
	UpwindFirstENO3b_impl* clone() const {
		return new UpwindFirstENO3b_impl(*this);
	};
...
private:
	...
	Disable operator=
	*/
	UpwindFirstENO3b_impl& operator=(const UpwindFirstENO3b_impl& rhs);
	/** @overload
	Disable copy constructor
	*/
	UpwindFirstENO3b_impl(const UpwindFirstENO3b_impl& rhs) : 
		type(rhs.type),
		dxs(rhs.dxs),
		dxInvs(rhs.dxInvs),
		...
		cache(new UpwindFirstENO3b_Cache(*rhs.cache))
	{
...
#endif	/* __UpwindFirstENO3b_impl_hpp__ */
