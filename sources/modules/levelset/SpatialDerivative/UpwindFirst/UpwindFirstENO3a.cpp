...
bool UpwindFirstENO3a_impl::execute_dim0_local_q(
	beacls::UVec& dst_deriv_l,
	beacls::UVec& dst_deriv_r,
	const FLOAT_TYPE* src,
	const HJI_Grid *grid,
...
#if 1	//!< Workaround, following operation doesn't support CUDA memory yet.
	std::vector<
	beacls::UVec > tmp_DD_uvec(DD_uvec.size());
	std::vector<beacls::UVec > tmp_dL_uvec(dL_uvec.size());
	std::vector<beacls::UVec > tmp_dR_uvec(dR_uvec.size());
	beacls::UVec tmp_deriv_l;
	beacls::UVec tmp_deriv_r;
...
bool UpwindFirstENO3a_impl::execute_dim1_local_q(
	beacls::UVec& dst_deriv_l,
	beacls::UVec& dst_deriv_r,
	const FLOAT_TYPE* src,
	const HJI_Grid *grid,
...
bool UpwindFirstENO3a_impl::execute_dimLET2_local_q(
	beacls::UVec& dst_deriv_l,
	beacls::UVec& dst_deriv_r,
	const FLOAT_TYPE* src,
	const HJI_Grid *grid,
...
bool UpwindFirstENO3a_impl::execute_local_q(
	beacls::UVec& dst_deriv_l,
	beacls::UVec& dst_deriv_r,
	const HJI_Grid *grid,
	const FLOAT_TYPE* src,
