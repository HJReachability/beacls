#ifndef __OdeCFL2_impl_hpp__
#define __OdeCFL2_impl_hpp__
...
class OdeCFL2_impl {
private:
	std::vector<beacls::OdeCFL_Worker*> workers;
	std::vector<beacls::OdeCFL_CommandQueue*> commandQueues;
	const Term* term;
...
public:
	...
	OdeCFL2_impl* clone() const {
		return new OdeCFL2_impl(*this);
	};
private:
	/** @overload
	Disable operator=
	*/
	OdeCFL2_impl& operator=(const OdeCFL2_impl& rhs);
	/** @overload
	Disable copy constructor
	*/
	OdeCFL2_impl(const OdeCFL2_impl& rhs);
};

#endif	/* __OdeCFL2_impl_hpp__ */
