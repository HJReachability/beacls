...
int main(int argc, char *argv[])
{
	...
	if (dump_file) {
		extraArgs.fig_filename = "MyPlane_test3_BRS";
	}
	...
	std::string MyPlane_test3_filename("MyPlane_test3.mat");
	beacls::MatFStream* fs = beacls::openMatFStream(MyPlane_test3_filename, beacls::MatOpenMode_Write);
	if (dump_file) {
	...
	if (dump_file) {
		extraArgs.fig_filename = "MyPlane_test3_Traj";
	}
