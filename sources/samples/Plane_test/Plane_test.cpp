...
int main(int argc, char *argv[])
{
	...
	levelset::HJI_Grid* g = helperOC::createGrid(
		...
		beacls::IntegerVec{ 41,41,11 }, beacls::IntegerVec{ 2 });
	...
	std::transform(
		obs1.cbegin(), obs1.cend(), obs2.cbegin(), obstacles[0].begin(),
	...
	computeOptTraj->operator()(traj, traj_tau, g, fliped_data, tau2, pl,
		extraArgs);
