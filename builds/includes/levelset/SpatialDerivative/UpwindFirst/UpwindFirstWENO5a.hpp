...
#ifndef __UpwindFirstWENO5a_hpp__
#define __UpwindFirstWENO5a_hpp__
...
namespace levelset {
	...
	class UpwindFirstWENO5a : public UpwindFirst {
	public:
		PREFIX_VC_DLL
			UpwindFirstWENO5a(
		...
		*/
		...
		bool operator==(const UpwindFirstWENO5a& rhs) const;
		bool operator==(const SpatialDerivative& rhs) const;
		UpwindFirstWENO5a* clone() const;
		beacls::UVecType get_type() const;
	private:
		UpwindFirstWENO5a_impl *pimpl;

		/** @overload
		Disable operator=
		*/
		UpwindFirstWENO5a& operator=(const UpwindFirstWENO5a& rhs);
		/** @overload
		Disable copy constructor
		*/
		UpwindFirstWENO5a(const UpwindFirstWENO5a& rhs);
	};
};
#endif	/* __UpwindFirstWENO5a_hpp__ */
