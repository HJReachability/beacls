...
#ifndef __UpwindFirstENO3a_hpp__
#define __UpwindFirstENO3a_hpp__
...
namespace levelset {
	...
	class UpwindFirstENO3a : public UpwindFirst {
	public:
		PREFIX_VC_DLL
			UpwindFirstENO3a(
		...
		*/
		...
		UpwindFirstENO3a* clone() const;
		beacls::UVecType get_type() const;
	private:
		UpwindFirstENO3a_impl *pimpl;

		/** @overload
		Disable operator=
		*/
		UpwindFirstENO3a& operator=(const UpwindFirstENO3a& rhs);
		/** @overload
		Disable copy constructor
		*/
		UpwindFirstENO3a(const UpwindFirstENO3a& rhs);
	};
};
#endif	/* __UpwindFirstENO3a_hpp__ */
