...
#ifndef __UpwindFirstWENO5b_hpp__
#define __UpwindFirstWENO5b_hpp__
...
namespace levelset {
	...
	class UpwindFirstWENO5b : public UpwindFirst {
	public:
		PREFIX_VC_DLL
			UpwindFirstWENO5b(
		...
		*/
		...
		bool operator==(const UpwindFirstWENO5b& rhs) const;
		bool operator==(const SpatialDerivative& rhs) const;
		UpwindFirstWENO5b* clone() const;
		beacls::UVecType get_type() const;
	private:
		UpwindFirstWENO5b_impl *pimpl;

		/** @overload
		Disable operator=
		*/
		UpwindFirstWENO5b& operator=(const UpwindFirstWENO5b& rhs);
		/** @overload
		Disable copy constructor
		*/
		UpwindFirstWENO5b(const UpwindFirstWENO5b& rhs);
	};
};
#endif	/* __UpwindFirstWENO5b_hpp__ */
